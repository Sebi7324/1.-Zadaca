...
namespace PongGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            PaddleBottom.Position = new Vector2((graphics.PreferredBackBufferWidth/2) - (PaddleBottom.Size.Width/2), graphics.PreferredBackBufferHeight-PaddleBottom.Size.Height);
            PaddleTop.Position = new Vector2((graphics.PreferredBackBufferWidth)/2 - (PaddleBottom.Size.Width / 2), 0); //je li ovo dobro?
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            { 
                ...
                Ball.Speed = Ball.Speed * Ball.BumpSpeedIncreaseFactor; HitSound.Play(); 
            }
